...
void Earth::Materials()
{
	...
	_material->ambient.x = 0.0; _material->ambient.y = 0.1; _material->ambient.z = 0.06;
	_material->ambient.w = 1.0;
	_material->diffuse.x = 0.0; _material->diffuse.y = 0.50980392; _material->diffuse.z = 0.50980392;
	_material->diffuse.w = 1.0;
	_material->specular.x = 0.50196078; _material->specular.y = 0.50196078; _material->specular.z = 0.50196078;
